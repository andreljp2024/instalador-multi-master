...
```bash
sudo apt install -y git && git clone https://github.com/andreljp2024/instalador-multi-master install && sudo chmod -R 777 ./install && cd ./install && sudo ./install_primaria
```
